...
INSERT INTO tb_cliente
    VALUES tp_cliente('32145678900', 'Bruna Alves',to_date('15/07/2001', 'dd/mm/yy'),'F', tp_telefones(tp_telefone('992199222')), tp_endereco('Recife', 'Jaguaribe', '78', 'Casa', 'Pernambuco', '50610510'), 'Unimed');

INSERT INTO tb_cliente
    VALUES tp_cliente('32146678900', 'Artur Carvalho',to_date('28/08/2001', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('991681119'), tp_telefone('988886543')), tp_endereco('Recife', 'Santos Dumont', '456', 'Apartamento', 'Pernambuco', '50350510'), 'Sulamerica');

INSERT INTO tb_cliente
    VALUES tp_cliente('32146670900', 'Gustavo Campos',to_date('10/12/2001', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('988346613')), tp_endereco('Recife', 'Tabaiares', '886', 'Apartamento', 'Pernambuco', '50350511'), 'Hapvida');

INSERT INTO tb_cliente
    VALUES tp_cliente('12146678900', 'Lucas Cavalcanti',to_date('07/03/2001', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('988338212'),tp_telefone('988335566')), tp_endereco('Recife', 'Sport Clube do Recife', '586', 'Apartamento', 'Pernambuco', '50351511'), 'Notredame');

INSERT INTO tb_funcionario
    VALUES tp_funcionario('32146679900', 'Matheus Frej',to_date('10/10/2001', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('994022444')), tp_endereco('Recife', 'Sigismundo Gonçalves', '230', 'Apartamento', 'Pernambuco', '51351511'), 'Recepcionista', 2200.00, TO_DATE('01/02/2022', 'dd/mm/yy'));

INSERT INTO tb_funcionario
    VALUES tp_funcionario('32146578900', 'Raissa Heimann',to_date('30/03/2001', 'dd/mm/yy'),'F', tp_telefones(tp_telefone('994022333')), tp_endereco('Recife', 'Boa Viagem', '20', 'Apartamento', 'Pernambuco', '51371511'), 'Recepcionista', 2200.00, TO_DATE('05/08/2021', 'dd/mm/yy'));

INSERT INTO tb_medico
    VALUES tp_medico('32246678900', 'Maria do Socorro Alves',to_date('09/09/2001', 'dd/mm/yy'),'F', tp_telefones(tp_telefone('999287566'), tp_telefone('999287500'), tp_telefone('999547566')), tp_endereco('Recife', 'Dom Manoel da Costa', '117', 'Casa', 'Pernambuco', '58881511'), 'Médico', 3000.00, TO_DATE('07/07/2018', 'dd/mm/yy'), '123');

INSERT INTO tb_cliente
    VALUES tp_cliente('32146677900', 'Ana Carla Guerra',to_date('26/03/2001', 'dd/mm/yy'),'F', tp_telefones(tp_telefone('994025554')), tp_endereco('Recife', 'Engenheiro Sampaio', '199', 'Casa', 'Pernambuco', '58881599'), 'Fachesf');

INSERT INTO tb_medico
    VALUES tp_medico('67885321900', 'Tiago Medeiros',to_date('30/05/1977', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('992155111')), tp_endereco('Recife', 'Boa Viagem', '220', 'Casa', 'Pernambuco', '51111221'), 'Médico', 2000.00, TO_DATE('01/10/2019', 'dd/mm/yy'), '345');

INSERT INTO tb_medico
    VALUES tp_medico('17846781900', 'Sabrina Rocha',to_date('02/07/1967', 'dd/mm/yy'),'F', tp_telefones(tp_telefone('993345211')), tp_endereco('Recife', 'Ilha do Leite', '333', 'Casa', 'Pernambuco', '51121221'), 'Médico', 2000.00, TO_DATE('01/10/2019', 'dd/mm/yy'), '567');

INSERT INTO tb_medico
    VALUES tp_medico('12246221900', 'Walmir Bispo',to_date('05/10/1972', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('993100017')), tp_endereco('Recife', 'Cajueiro', '111', 'Casa', 'Pernambuco', '51155521'), 'Médico', 3500.00, TO_DATE('22/04/2020', 'dd/mm/yy'), '789');

INSERT INTO tb_medico
    VALUES tp_medico('55511121900', 'Jean Carlos',to_date('02/11/1992', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('993103010'), tp_telefone('991586284')), tp_endereco('Recife', 'Rosa e Silva', '95', 'Casa', 'Pernambuco', '57740821'), 'Médico', 4500.00, TO_DATE('09/09/2019', 'dd/mm/yy'), '999');

INSERT INTO tb_medico
    VALUES tp_medico('32217721111', 'Meiry Lanunce',to_date('02/11/1969', 'dd/mm/yy'),'F', tp_telefones(tp_telefone('993111010')), tp_endereco('Olinda', 'Peixinhos', '95', 'Casa', 'Pernambuco', '57123821'), 'Médico', 2500.00, TO_DATE('15/03/2022', 'dd/mm/yy'), '111');

INSERT INTO tb_funcionario
    VALUES tp_funcionario('32177765322', 'Gilberto Luiz',to_date('02/10/1980', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('993777710')), tp_endereco('Camaragibe', 'Estação Nova', '100', 'Casa', 'Pernambuco', '57161111'), 'Segurança', 3200.00, TO_DATE('25/05/2019', 'dd/mm/yy'));

INSERT INTO tb_funcionario
    VALUES tp_funcionario('55566621111', 'Junior Tavares',to_date('07/05/1992', 'dd/mm/yy'),'M', tp_telefones(tp_telefone('993277733')), tp_endereco('Olinda', 'Rio Doce', '05', 'Casa', 'Pernambuco', '57178899'), 'Segurança', 3200.00, TO_DATE('22/07/2020', 'dd/mm/yy'));
